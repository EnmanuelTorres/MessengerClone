...
/// Controller that shows lits of conversations
 final class ConversationsViewController: UIViewController {
     ...
     private func createNewConversation(result: SearchResult){
         ...
         // otherwise use existing conversation
         
         DatabaseManager.shared.conversaionExists(with: email, completion: {[weak self] result in
             guard let strongSelf = self else {
                 return
             }
             switch result {
